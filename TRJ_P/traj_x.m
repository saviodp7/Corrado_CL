...
t_tr=tempo_traj/10;
 ...
 path_descr = struct("inizio", [start_pos; altosin_x+[0,0,0.03]; altosin_x; bassodestra_x; bassodestra_x+[0,0,0.03]; altodestra_x+[0,0,0.03];altodestra_x; bassosin_x; bassosin_x+[0,0,0.03];], ...
                "fine", [altosin_x+[0,0,0.03]; altosin_x; bassodestra_x; bassodestra_x+[0,0,0.03]; altodestra_x+[0,0,0.03]; altodestra_x; bassosin_x; bassosin_x+[0,0,0.03]; start_pos;]);

[s_1,s_1_dot,s_1_dotdot] = trap_profile(0, t_tr,   f_s, start_pos, altosin_x+[0,0,0.03], tempo_traj, "rect");
[s_2,s_2_dot,s_2_dotdot] = trap_profile(t_tr, 2*t_tr, f_s, altosin_x+[0,0,0.03], altosin_x, tempo_traj, "rect");
% [s_2_5,s_2_5_dot,s_2_5_dotdot] = trap_profile(2*t_tr, 2.5*t_tr, f_s, altosin_x, altosin_x,tempo_traj, "rect");
[s_3,s_3_dot,s_3_dotdot] = trap_profile(2*t_tr, 4*t_tr, f_s, altosin_x, bassodestra_x,tempo_traj, "rect");
...
[s_4,s_4_dot,s_4_dotdot] = trap_profile(4*t_tr, 5*t_tr, f_s, bassodestra_x,  bassodestra_x+[0,0,0.03],tempo_traj, "rect");
[s_5,s_5_dot,s_5_dotdot] = trap_profile(5*t_tr ,6*t_tr, f_s,bassodestra_x+[0,0,0.03], altodestra_x+[0,0,0.03],tempo_traj, "rect");
% [s_6_5,s_6_5_dot,s_6_5_dotdot] = trap_profile(6*t_tr, 6.5*t_tr, f_s, altodestra_x, altodestra_x,tempo_traj, "rect");
[s_6,s_6_dot,s_6_dotdot] = trap_profile(7*t_tr, 8*t_tr, f_s, altodestra_x+[0,0,0.03], altodestra_x,tempo_traj, "rect");
[s_7,s_7_dot,s_7_dotdot] = trap_profile(8*t_tr, 10*t_tr, f_s, altodestra_x, bassosin_x,tempo_traj, "rect");
% [s_7_5,s_7_5_dot,s_7_5_dotdot] = trap_profile(7.5*t_tr, 8*t_tr, f_s, bassosin_x, bassosin_x,tempo_traj, "rect");
[s_8,s_8_dot,s_8_dotdot] = trap_profile(10*t_tr, 11*t_tr, f_s, bassosin_x, bassosin_x+[0,0,0.03],tempo_traj, "rect");
[s_9,s_9_dot,s_9_dotdot] = trap_profile(11*t_tr ,12*t_tr ,  f_s, bassosin_x+[0,0,0.03], start_pos, tempo_traj, "rect");
